package com.wangwei.aspect;

import com.wangwei.annotation.AutoFill;
import com.wangwei.constant.AutoFillConstant;
...
public class AutoFillAspect {
    @Pointcut("execution(* com.wangwei.mapper.*.*(..)) && @annotation(com.wangwei.annotation.AutoFill)")
